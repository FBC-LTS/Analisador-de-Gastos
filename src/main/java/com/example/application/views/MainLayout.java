...
public class MainLayout extends AppLayout {
    ...
    private Component createHeaderContent() {
        ...
        header.addClassNames(BoxSizing.BORDER, Display.FLEX, FlexDirection.ROW, Width.FULL, JustifyContent.BETWEEN);

        Div layout = new Div();
        layout.addClassNames(Display.FLEX, AlignItems.CENTER, Padding.Horizontal.LARGE);

        Image logo = new Image("./images/Logo.png", "Logo Gestor");
        logo.setWidth("50px");
        layout.add(logo);
        ...
        Nav nav = new Nav();
        nav.addClassNames(Display.FLEX, Overflow.AUTO, Padding.Horizontal.MEDIUM, Padding.Vertical.XSMALL, AlignSelf.CENTER);
    ...
    private MenuItemInfo[] createMenuItems() {
        return new MenuItemInfo[]{ //
                ...
                new MenuItemInfo("Documentação", LineAwesomeIcon.FILE.create(), DocumentaçãoView.class), //
                
                new MenuItemInfo("Sobre", LineAwesomeIcon.ADDRESS_CARD_SOLID.create(), SobreView.class), //
